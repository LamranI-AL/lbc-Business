...
export default function TarifsEpilationPage() {
  ...
  const tarifsFemme = [
    { zone: "Aisselles", prix: "57.87", sessions: "1" },
    { zone: "Maillot classique", prix: "72.37", sessions: "1" },
    ...
    { zone: "Aisselles (pack)", prix: "72.87", sessions: "1" },
    { zone: "Avant-bras", prix: "43.87", sessions: "1" },
    { zone: "Bras complets", prix: "53.87", sessions: "1" },
    { zone: "Articules des seins", prix: "17.87", sessions: "1" },
    ...
    { zone: "Dos - haut", prix: "46.87", sessions: "1" },
    { zone: "Dos complet", prix: "78.87", sessions: "1" },
    { zone: "Maillot intégral", prix: "72.87", sessions: "1" },
    { zone: "Maillot échancré", prix: "33.87", sessions: "1" },
    { zone: "Maillot français", prix: "44.87", sessions: "1" },
    { zone: "Fesses", prix: "17.87", sessions: "1" },
